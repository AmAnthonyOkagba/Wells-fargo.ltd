    ...
    <div class="nav-header">
       ...
       <div class="container">
           <div class="row" style="margin-top:70px">
                <h4 style="color:lightcyan; font-weight:bold;">Account Dashboard</h4>
                ...
                <div class="plan"> 
                    ...
                    <span class="btn btns blue-grey darken-3" style="border-radius:10px">MAKE DEPOSIT</span>

                    <span class="btn blue-grey darken-3 btns" style="margin-left:30px; border-radius:10px">WITHDRAWAL FUNDS</span>
                    <p style="color:rgb(185, 213, 255);">Earned Total: <span class="white-text" style="margin-left:100px">$0.00</span></p>
                    <p style="color:rgb(185, 213, 255);">Pending Withdrawal: <span class="white-text" style="margin-left:38px">$0.00</span></p>
                    <p style="color:rgb(185, 213, 255);">Withdrawal Total: <span class="white-text" style="margin-left:65px">$0.00</span></p>
                    <p style="color:rgb(185, 213, 255);">Referral: <span class="white-text" style="margin-left:135px">$0.00</span></p>
                </div>
                <div class="col l6 m6 s12" style="padding-left:300px">
                    ...
                    <a href="deposithistory" class="btn btns blue-grey darken-3" style="padding-right:98px; font-weight:lighter">DEPOSIT LIST</a><br><br>
