    ...
    <div class="nav-header">
       ...
       <div class="container">
           <div class="row" style="margin-top:70px">
                <h4 style="color:lightcyan; font-weight:bold;">Make Investment</h4>
                <div class="divider white" style="margin-bottom:40px"></div>
                <div class="col l8 m8 s12" style="margin-top:50px">
                    <table border="1" class="table" style="color:lightcyan; border-bottom-right-radius:40px">                 
            <label>
                ...
                <span>BASIC PLAN</span>
                       ...
                       <thead>
                             <tr>
                                <th>Plan</th>
                                <th style="text-align:right">Spend Amount ($)</th>
                                <th style="text-align:right;">Bi Weekly Profit (%)</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>BASIC PLAN</td>
                                <td style="text-align:right">$200.00 - $2000.00</td>
                                <!-- <td style="text-align:righ">$2000.00</td> -->
                ...
                <span>STANDARD PLAN</span>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>STANDARD PLAN</td>
                                <td style="text-align:right">$2000.00 - $5000.00</td>
                ...
                <span>PRO PLAN</span>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>PRO PLAN</td>
                                <td style="text-align:right">$5000.00 - $10,000.00</td>
                ...
                <span>ULTIMATE PLAN</span>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>ULTIMATE PLAN</td>
                                <td style="text-align:right">$1000.00 - ULTIMATE</td>
                                <!-- <td style="text-align:right">ULTIMATE</td> -->
                    ...
                    <span class="white-text" style="font-size:40px">$0.00</span><br><br>
                    <form action="investment.php">
                        <div class="white-text blue-grey darken-2" style="padding: 8px 28px 8px 28px; border-top-left-radius:40px; background-color:blue-grey">
                           <p class="white-text">INVESTMENT AMOUNT:</p> <input type="text" class="white-text" placeholder="  USD" style="border: 1px solid white">
                           <p>PLAN NAME:</p>
                         
                          <div>
                          <select name="" id="">
                               <option value="Choose an Option" style="color:white"> Choose an Option</option>
                           ...
                           <!-- <p>TRANSACTION ID:</p><input type="text" placholder="" class="white-text" style="border:1px solid white"> -->
                        </div>
                       <div style="margin-left:250px; margin-top:30px;">
                       <input type="sumbit" class="btn bntz blue-grey darken-3 btns" style=" border-radius:6px;" value="INVEST">
                       </div>
                    </form>

                </div>
                <div class="col l4 m4 s12" style="padding-left:120px">
