    ...
    <div class="nav-header">
       ...
       <div class="container">
           <div class="row" style="margin-top:70px">
                <h4 style="color:lightcyan; font-weight:bold;">PROMO MATERIALS</h4>
                <div class="divider white" style="margin-bottom:25px"></div>
                <div class="col l8 m6 s12">
                   <p style="color:lightcyan; font-size:16px">Your personal affiliate link : <span></span></p>
                </div>
                <div class="col l4 m6 s12" style="padding-left:100px">
