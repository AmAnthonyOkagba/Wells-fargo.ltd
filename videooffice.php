...
<div class="nav-header">
    <div> 
      ...
      <header>         
          ...
          <ul>
              ...
              <li class="nav-item" style="margin-left: 15px; margin-right: 15px;">  
                 <a href="videooffice.php" class="fer home">Video Office</a>
              </li>
   ...
   <div class="container">
        <div class="center">
            <h4 style="color:rgb(185, 213, 255); font-size: 38px; font-weight: bold; padding-bottom: 200px; margin-top: 120px;" class="plan">VIDEO OFFICE</h4>
...
<section style="padding: 20px;">
   ...
   <!-- investment offer -->
   <section style="margin-top: 10px; padding: 20px; background-color: whitesmoke;">
    <div class="container">
      <div class="row">
        <h5  style="color:rgb(143, 178, 231); font-weight: bold;">Video Office</h5>
        <div class="divider"></div>
        <div class="col l8 s12 m8">
        <p style="text-align: justify;">Want to share your opinion about the company and its investment offer or to know the opinion of others? In this section you will find all the videos that tell about wells-fargo.ltd: presentation of our business, description of the processes of Bitcoin mining, testimonials of satisfied investors and reviews of popular bloggers from the sphere of online investment. We are confident that you will find a lot of useful information here, it will help you to form a general impression of the work with us.</p> 
      </div>
      <div class="col l4 s12 m4 push-l2">
            <img src="img/youtube.png" width="50%" class="filter" alt="">
      </div>
    </div>
    ...
    <div class="container">
        <div class="">
            <h5  style="color:rgb(143, 178, 231); font-weight: bold;">Video presentation</h5>
            <div class="divider" style="margin-bottom: 30px;"></div>
        </div>
        <iframe width="100%" height="596" src="https://www.youtube.com/embed/Gc2en3nHxA4" frameborder="0" allowfullscreen></iframe>
    </div>
</section>
