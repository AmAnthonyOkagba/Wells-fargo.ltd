    ...
    <div class="nav-header">
       ...
       <div class="container">
           <div class="row" style="margin-top:70px">
                <h4 style="color:lightcyan; font-weight:bold;">Deposits history</h4>
                <div class="divider white" style="margin-bottom:40px"></div>
                <div class="col l8 m6 s12" style="margin-top:50px">
                    <table border="1" class="table blue-grey darken-2" style="color:lightcyan; border-bottom-right-radius:40px">
                        <thead>
                             <tr>
                                <th>Type</th>
                                <th>Amount</th>
