    ...
    <div class="nav-header">
       ...
       <div class="container">
           <div class="row" style="margin-top:70px">
                <h4 style="color:lightcyan; font-weight:bold;">ROLLOVER</h4>
                ...
                <div class="plan"> 
                    ...
                    <form action="rollover.php">
                        <div class="white-text blue-grey darken-2" style="padding: 8px 28px 38px 28px; border-top-left-radius:40px; background-color:blue-grey">
                           <p class="white-text">AMOUNT TO ROLLOVER:</p> <input type="text" class="white-text" placeholder="  USD" style="border: 1px solid white">
                          
                        </div>
                       <div style="margin-left:200px; margin-top:30px;">
                       <input type="sumbit" class="btn bntz blue-grey darken-3 btns" style=" border-radius:6px;" value="deposit">
                       </div>
                    </form>
