...
<div class="nav-header">
      ...
      <header>         
          ...
          <ul>
              ...
              <li class="nav-item" style="margin-left: 15px; margin-right: 15px;">
               ...
               <li class="nav-item " style="margin-left: 15px; margin-right: 15px;">
                  <a href="officialrepresentative.php" class="fer home">Official Representatives</a>
               </li>
   ...
   <div class="container">
        <div class="center">
            <h4 style="color:rgb(185, 213, 255); font-size: 38px; font-weight: bold; padding-bottom: 200px; margin-top: 120px;" class="plan">OFFICIAL REPRESENTATIVE</h4>
