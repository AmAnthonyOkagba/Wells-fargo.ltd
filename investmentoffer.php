...
<div class="nav-header">
     ...
     ?>
      ...
      <header>         
          ...
          <ul>
              ...
              <li class="nav-item" style="margin-left: 15px;margin-right: 15px;">
                <a href="investmentoffer.php" class="fer home">Investment Offer</a>
              </li>
   ...
   <div class="container">
        <div class="center">
            <h4 style="color:rgb(185, 213, 255); font-size: 38px; font-weight: bold; padding-bottom: 200px; margin-top: 120px;" class="plan">INVESTMENT OFFER</h4>
      ...
      <div class="row">
        <h5  style="color:rgb(143, 178, 231); font-weight: bold;">About Wells-Fargo.ltd</h5>
          <div class="col l3" style="margin-top: 70px;">
            <img src="img/gear.png" class="responsive-img filter" alt="">
          </div>
          <div class="col l9 push-l1">
              <p>Investment offer of wells-fargo.ltd is open to all comers. A distinctive feature of our project are every day accruals - your income only depends on the size of your deposit: 6%, 10% and 15% every every day.</p>

              <p>Minimum deposit from which you can start your cooperation with the company is $200. If you want to convert Bitcoin in your local currency, use the handy online converter at <a href=" http://bitcoinexchangerate.org." target="_blank">http://bitcoinexchangerate.org.</a></p>

              <p>Your deposit can be for any amount, but not less than $200, you can also have a few deposits at different amounts simultaneously: each deposit will have its own terms of accrual according to amount, as well as its own time of every day accrual.
              </p>
         
              <p>The first profit will be accrued within an 24 hours, at the expiration of a full 60 minutes after the addition of deposit. If you have several deposits, the accruals will occur several times an hour.</p>
              
              <p>As soon as your balance will amount more than $200, you can make a request for withdrawal. All such requests are processed automatically and instantly.</p>

              <p>Investment terms ofwells-fargo.ltd project involve working 24/7, which means that you earn every day for 7 days a week.</p>
              <p>his feature will be available after full 24 hours since addition your deposit. To get back a principal, click [Release] next to your deposit amount in your account. The deposit will be reflected on your account balance instantly and without any fee. Then you can make a new deposit or withdraw this amount.</p>
          </div>
      </div>
    </div>
</section>
